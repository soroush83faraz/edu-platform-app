"use client"
// Generated by shadcn; TWO owned lines in `DialogContent`'s close button — re-apply both after a re-generation:
//   1. the sr-only text is Persian («بستن») (CLAUDE.md «Frontend rules»: no English strings in UI);
      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close data-slot="dialog-close" asChild>
            <Button
              variant="ghost"
              className="absolute top-2 end-2 md:size-9"
              size="icon"
            >
              <XIcon
              />
