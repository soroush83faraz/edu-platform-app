"use client"
// Generated by shadcn; ONE owned line — the close button's sr-only text is Persian («بستن»). Re-apply after a
// re-generation (CLAUDE.md «Frontend rules»: no English strings in UI).
