 ...
 * (docs/decisions.md). Since QA round 5 the list is people and roles only; the structure pages are Home tiles
 * (`HOME_TILES`), so nothing here is rewritten per scope any more.
 */
