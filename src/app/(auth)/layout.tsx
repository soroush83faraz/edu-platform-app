...
/**
 * The pre-app pages (login, forced password change): the tinted canvas, the product mark on top, one centred card.
 * A faint icy-blue glow behind the card is the only decoration.
 */
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-canvas px-4 py-8">
